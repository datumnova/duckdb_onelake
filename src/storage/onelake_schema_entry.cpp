...
optional_ptr<CatalogEntry> OneLakeSchemaEntry::CreateFunction(CatalogTransaction transaction, CreateFunctionInfo &info) {
...
optional_ptr<CatalogEntry> OneLakeSchemaEntry::CreateSequence(CatalogTransaction transaction, CreateSequenceInfo &info) {
...
optional_ptr<CatalogEntry> OneLakeSchemaEntry::CreateCollation(CatalogTransaction transaction, CreateCollationInfo &info) {
...
OneLakeSchemaEntry::LookupEntry(CatalogTransaction transaction, const EntryLookupInfo &lookup_info) {
